...
def test_get_assignments_in_graded_state_for_each_student():
    ...
    expected_result = [(None, 0)]  # Adjust the expected result based on your SQL query
    ...
    # Check if the SQL result matches the expected result
    assert sql_result == expected_result
